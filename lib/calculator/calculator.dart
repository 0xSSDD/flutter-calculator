...
class Calculations {
  ...
  static const EQUAL = '=';
  static const KM_MILE = 'KM_MILE';
  static const MILE_KM = 'MILE_KM';
  static const POW = '^';
  ...
  static double km_mile(double a) => a / 0.621371;
  static double mile_km(double a) => a * 0.621371;
}
...
class Calculator {
  static String parseString(String text) {
    ...
    } else if (text.contains(Calculations.POW)) {
      numbersToAdd = text.split(Calculations.POW);
      a = double.parse(numbersToAdd[0]);
      b = double.parse(numbersToAdd[1]);
